...
description: Architecture détaillée des graphes d'embedding et de traitement batch
sidebar:
  order: 6
---
...
4. **Traitement commun** → **Sortie** : Chunking, enrichissement optionnel, embedding, fin
