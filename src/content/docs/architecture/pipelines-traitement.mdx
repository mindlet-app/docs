...
<MermaidDownload title="Vue d'ensemble des pipelines">
```mermaid
flowchart TB
...
<MermaidDownload title="Pipeline Texte">
```mermaid
graph LR
...
<MermaidDownload title="Pipeline PDF">
```mermaid
graph TB
...
<MermaidDownload title="Pipeline Image">
```mermaid
graph LR
...
<MermaidDownload title="Pipeline Audio">
```mermaid
graph LR
...
<MermaidDownload title="Pipeline YouTube">
```mermaid
graph TB
...
<MermaidDownload title="Pipeline Website">
```mermaid
graph LR
