...
description: Architecture et fonctionnement du service IA de Mindlet basé sur LangGraph
sidebar:
  order: 4
---
...
```
Ressource brute → [Embedding Graph] → Chunks vectorisés → [Card Generator] → Cartes d'apprentissage
                        ↑
          [Batch Embedding Graph] ← Plusieurs ressources
```
