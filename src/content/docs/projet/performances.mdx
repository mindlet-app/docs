---
title: Performances et scalabilité
description: Évaluation des performances et stratégies de montée en charge
sidebar:
  order: 4
---
...
<Tabs>
  <TabItem label="API Backend">
    ...
    **Durée:** 60 secondes
    ...
    <MermaidDownload title="Benchmark API">
    ```mermaid
    xychart-beta
  ...
  <TabItem label="Génération IA">
    ...
    **Modèle:** GPT-4
    ...
    <MermaidDownload title="Répartition temps de génération">
    ```mermaid
    pie showData
