...
<Aside type="note">
  Ce document retrace le parcours du projet Mindlet, de sa conception à aujourd'hui. Un véritable journal de bord de notre aventure entrepreneuriale étudiante.
</Aside>

## 🌱 Les origines (Septembre 2025)
...
![Architecture initiale](../../../assets/elements/first-architecture.png)
...
En parallèle de notre développement technique, de nombreuses questions se sont posées :
