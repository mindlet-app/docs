---
title: Génération de cartes
description: Architecture agentic du Card Generator Graph pour la création de cartes d'apprentissage
sidebar:
  order: 7
---
...
```
Planner → Generator → Critic → Refiner ↺ (boucle si qualité insuffisante)
                          ↓
                     Finalizer
```
